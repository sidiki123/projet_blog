<footer class="footer-distributed" style="font-family: CanalBoldRomain">

			<div class="footer-left">

                <p style="font-size: 32px; color: #fff">Le Technicien Agréé</p>
			...
			<div class="footer-center">
				...
				<div>
					...
					<p><span>Rue de l'integrité</span> Zone ZACA</p>
				</div>
...
<div class="footer-distributed " style="font-family: CanalBoldRomain">


        <p class="footer">
            <a type="button" class="btn btn-dark p-3" href="{{route('index')}}" style="font-size:18px;">Accueil</a>

            <a type="button" class="btn btn-dark p-3" href="{{route('animations')}}" style="font-size:18px;">Contacter un technicien</a>

            <a type="button" class="btn btn-dark p-3" href="{{route('google_map')}}" style="font-size:18px;">Vérifier un technicien</a>

            <a type="button" class="btn btn-dark p-3" href="{{route('typography')}}" style="font-size:18px;">Nous Contacter</a>

            <a type="button" class="btn btn-dark p-3" href="{{route('a_propos')}}" style="font-size:18px;">A propos</a>
        </p>

        <p class="footer-company-name mt-5">Le Technicien Agrée © 2020</p>
