...
<div class="breadcomb-area">
								...
								<div class="breadcomb-wp">
                                    ...
                                    <form action="{{route('technicien.search')}}" method="GET">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            @if (request()->input('q'))
                                            <h2>{{$techniciens->total()}} résultat(s) pour la recherche <span style="color:red">" {{request()->q}} "</span> </h2>
  ...
  <path d="M0 9H22M12 1.5L20.9333 8.2C21.4667 8.6 21.4667 9.4 20.9333 9.8L12 16.5" stroke="black" stroke-width="3"/>
    ...
    @empty
            ...
            <center> <div class=" container alert alert-info"> Aucun Technicien avec ce identifiant </div></center>
            @endforelse
            </div>
        </div>
    </div>
